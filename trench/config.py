...
class DiscoveryConfig(Section):
    ...
    Trench logs a warning rather than publishing something inert.
    """
    enabled: bool = False
...
class QueryLogConfig(Section):
    ...
    db: str = "trench.db"      # relative to data_dir
...
class UpdatesConfig(Section):
    """Whether Trench looks for its own updates, and what it may do about one.
