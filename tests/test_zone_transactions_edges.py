"""Authoritative zone transactions, the awkward cases: transfer ACL default-deny,
IXFR delta handling, re-sign stability (stable DS, no artifact duplication),
reload keeping DB clients, TSIG-signed UPDATE responses."""
